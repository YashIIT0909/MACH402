...
const NODES = [
  {
    ...
    // A session container that can actually use the card.
    leases: {
      ...
      price_tinybars_per_second: "3334",
      chunk_seconds: 300,
    },
    online: true,
  ...
  },
  {
    ...
    leases: {
      ...
      payment_mode: "session",
      price_tinybars_per_second: "1000",
      chunk_seconds: 300,
    },
    online: true,
  ...
  },
  {
    ...
    leases: {
      price_tinybars_per_minute: "1500000",
      min_minutes: 5,
      max_minutes: 120,
      max_total_minutes: 1440,
      ssh: false,
      ...
      egress_allowlist: ["pypi.org", "files.pythonhosted.org"],
      payment_mode: "session",
      price_tinybars_per_second: "25000",
      chunk_seconds: 300,
    },
    online: true,
  ...
  },
  {
    ...
    leases: {
      price_tinybars_per_minute: "40000",
      min_minutes: 5,
      max_minutes: 120,
      max_total_minutes: 1440,
      ssh: false,
  ...
  },
  {
    ...
    // ending the session already running on it.
    ...
    leases: {
      price_tinybars_per_minute: "750000",
      min_minutes: 5,
      max_minutes: 120,
      max_total_minutes: 1440,
      ssh: false,
      ...
      egress_allowlist: ["pypi.org", "files.pythonhosted.org"],
      payment_mode: "session",
      price_tinybars_per_second: "12500",
      chunk_seconds: 300,
    },
    online: true,
  ...
  },
  {
    ...
    leases: {
      price_tinybars_per_minute: "150000",
      min_minutes: 5,
      max_minutes: 120,
      max_total_minutes: 1440,
      ssh: false,
      ...
      egress_allowlist: ["pypi.org", "files.pythonhosted.org"],
      payment_mode: "session",
      price_tinybars_per_second: "2500",
      chunk_seconds: 300,
    },
    online: false,
